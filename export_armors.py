...
NamesUnderscored = [
   {'Platform':'PrimalItemArmor_'},
   {'BossTribute':'PrimalItem_'},
   {'Scuba':'PrimalItemArmor_'},
   {'Tek':'PrimalItemArmor_'},
   {'Launch':'PrimalItemArmor_'},
   {'Saddle':'PrimalItemArmor_'},
   {'WW_':'PrimalItemSkin_'},
   {'TT_':'PrimalItemSkin_'},
   {'TekHelmet':'PrimalItemSkin_'},
   {'SwimShirt':'PrimalItemSkin_'},
   {'Sweater':'PrimalItemSkin_'},
   {'SunGlasses':'PrimalItemSkin_'},
   {'Summer_':'PrimalItemSkin_'},
   {'SummerSwimShirt':'PrimalItemSkin_'},
   {'PlayerCostume':'PrimalItemSkin_'},
   {'MachinedPistol':'PrimalItemSkin_'},
   {'HeartSpringsHat':'PrimalItemSkin_'},
   {'HawaiianShirt':'PrimalItemSkin_'},
   {'Flamethrower':'PrimalItemSkin_'},
   {'FE_':'PrimalItemSkin_'},
   {'EasterBasket':'PrimalItemSkin_'},
   {'Costume':'PrimalItemSkin_'},
   {'Club':'PrimalItemSkin_'},
   {'Boomeran':'PrimalItemSkin_'},
   {'SkinAttachment':'SKComponent_'},
   {'ChibiDino':'PrimalItemSkin_'},
   {'CharacterSkin':'PrimalItemSkin_'},
   {'AAA':'PrimalItemCostume_'},
   {'PlayerCosmetic':'PrimalItemSkin_'},
   {'DungeonEntrance':'PrimalItem_'}
]
...
def createBPPath(asset):
   ...
   # temp
   if 'Armor' not in str(asset.package_path): return ""
...
def export_json(results):
  ...
  with open(base_directory+'blueprints-armor.json', 'w', encoding='utf-8') as json_file:
