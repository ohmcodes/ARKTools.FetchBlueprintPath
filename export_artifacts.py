...
def createBPPath(asset):
   ...
   # temp
   if 'Artifacts' not in str(asset.package_path): return ""
...
def export_json(results):
  ...
  with open(base_directory+'blueprints-artifacts.json', 'w', encoding='utf-8') as json_file:
