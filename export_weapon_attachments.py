...
NamesUnderscored = [
   #{'PrimalItemTrophy':'PrimalItemTrophy_'},
]
...
def createBPPath(asset):
   ...
   # temp
   if 'WeaponAttachments' not in str(asset.package_path): return ""
...
def export_json(results):
  ...
  with open(base_directory+'blueprints-weaponattachments.json', 'w', encoding='utf-8') as json_file:
